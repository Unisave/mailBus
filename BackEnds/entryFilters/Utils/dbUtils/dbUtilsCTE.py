...
with open('./BackEnds/entryFilters/Utils/dbUtils/trackerDBConfig.json') as json_auth_file:
    ...
    db2mysqlTabName = authdata["TrakStatHlrSel"]["TabName"]
    ...
    db3mysqlTabName = authdata["TrakStatHlrUpd"]["TabName"]
    ...
    db4mysqlTabName = authdata["TrakStatHlrIns"]["TabName"]
        ...
        if results2:
            ...
            try:
                ...
                cursor3.execute (""" 
                    ...
                    WHERE tracker = '%s'
                    """ 
                    % (unicode(db3mysqlTabName), unicode(var2), unicode(var5), unicode(var3), unicode(var4), unicode(var1)))
            ...
            try:
                ...
                cursor4 = db4.cursor()
                cursor4.execute (""" 
                    INSERT INTO %s (numberOfClicks, tracker, openedLocationIP, TIMESTAMPER, openGeoLocation) 
                    VALUES ('1', '%s', '%s', '%s', '%s')
                    """ 
